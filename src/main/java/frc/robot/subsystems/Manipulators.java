...
// public Manipulators() {// TODO: Change deviceId to canspark ids or something
// idk im new
// wristRotationMotor = new SparkMax(18, MotorType.kBrushless);
// coralWheelMotor = new SparkMax(19, MotorType.kBrushless);
// algaeWheelMotor = new SparkMax(20, MotorType.kBrushless);
