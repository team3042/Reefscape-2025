...
motorConfig.idleMode(SparkMaxConfig.IdleMode.kBrake);
       elevatorMotor.configure(motorConfig, SparkMax.ResetMode.kResetSafeParameters, SparkMax.PersistMode.kPersistParameters);
       coralWheelMotor.configure(motorConfig, SparkMax.ResetMode.kResetSafeParameters, SparkMax.PersistMode.kPersistParameters);
        
       elevatorMotor.getEncoder().setPositionConversionFactor(42);
...
// does this need to be the robot height???///////////////////////////////////////////////////////////////////////////NOTICE ME
